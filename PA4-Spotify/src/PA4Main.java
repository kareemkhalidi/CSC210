/*
 * This class was provided to me as a part of the assignment
 * and was not written by me. All other classes for this
 * project were written 100% from scratch by me.
 */
...
public class PA4Main {
	...
	public static void userInterface(User currentUser, UserCollection allUsers, Library lib, Scanner input) {
		...
		System.out.println("Welcome to Music Streaming Service, please select an option:");
