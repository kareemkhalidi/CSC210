...
* 
* USAGE: 
* Add edges to the graph with a distance to represent
* how far the 2 nodes bordering the edge are. Once all
* edges are in the DGraph, you can then get the distance
